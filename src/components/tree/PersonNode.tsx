  ...
  return (
    <div className="relative">
      ...
      >
        <div className="px-2 py-2 flex flex-col items-center gap-0.5">
          <div className="flex items-center justify-center gap-1">
            ...
            {isSuperAdmin && (
              <span title="Tài khoản Super Admin" className="text-[10px] px-1 py-0.5 bg-brand-100 text-brand-700 rounded-full font-medium leading-none shrink-0">
                SA
              </span>
            )}
          </div>
      ...
      <Button
        ...
        title="Thêm con"
        className="absolute -bottom-3.5 left-1/2 -translate-x-1/2 z-10 rounded-full shadow-sm text-gray-400 hover:border-primary hover:text-primary"
      >
        +
      </Button>
    </div>
